...
import {
  getDataSeriesDetails,
  getDataSeriesPeople,
  getDataTrailerSeries
} from "../../redux/SeriesDetails.jsx/getDataSeriesDetails";
...
const BackgroundSeries = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="absolute z-20 mt-20 text-center font-bold text-3xl text-[#2dcaf0]">
        Series - Details
      </h1>
      <div className="z-10 mt-24 flex lg:flex-row flex-col items-center gap-5 w-full justify-center">
        ...
        <div className="md:w-[690px] lg:text-start text-center">
          ...
          <div className="font-bold text-white text-sm my-4">
            <span className="me-2"> {userDetails?.first_air_date}</span>
            <span className="me-2">
            ...
            <span>👈</span>
            <span className="ms-2">
              Epoisode Run Time {userDetails?.episode_run_time} min
            </span>
          </div>
          <div>
